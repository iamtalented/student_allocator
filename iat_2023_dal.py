...
def generate_class_lists(students):
    ...
    for student in students:
        for i in range(SESSIONS):
            ...
            class_list[student[cur_session]][cur_session].append((student["name"], student["school"]))
    return class_list
...
def write_to_student_list_to_sheet(sheet, students):
    ...
    for student in students:
        ...
        sheet["C" + cur_row_str] = student["session1"]
        sheet["D" + cur_row_str] = student["session2"]
        sheet["E" + cur_row_str] = student["session3"]
        cur_row += 1
...
def write_class_list_to_sheet(sheet, class_list, course_name):
    ...
    for i in range(SESSIONS):
        ...
        cur_row += 1
        for student, school in class_list[cur_session]:
