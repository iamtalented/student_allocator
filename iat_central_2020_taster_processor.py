...
def export_list(students, filename):
    ...
    cur_sheet["E1"] = "Session 1"
    cur_sheet["F1"] = "Session 2"
    cur_sheet["G1"] = "Session 3"
    cur_row += 1
    for student in students:
        cur_sheet["A" + str(cur_row)] = student["name"]
        cur_sheet["B" + str(cur_row)] = student["school"]
        cur_sheet["C" + str(cur_row)] = student["class"]
        cur_sheet["D" + str(cur_row)] = generate_id
        cur_sheet["E" + str(cur_row)] = student["session1"]
        cur_sheet["F" + str(cur_row)] = student["session2"]
        cur_sheet["G" + str(cur_row)] = student["session3"]
        cur_row += 1
    wb.save(filename)
